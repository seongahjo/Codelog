...
11. Interceptor와 Filter의 순서와 차이점을 설명하시오
    ...
    2. Request와 Response는 DispatcherServlet에 가기전에 Filter를 거친다. Filter와 Interceptor는 실행되는 시점이 다르다. Filter는 WebApplication에 등록을 하고 Interceptor는 Spring의 Context에 등록한다.
